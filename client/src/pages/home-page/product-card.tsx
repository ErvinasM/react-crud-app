...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  <Stack sx={{ border: 1.6, borderColor: '#efefef', borderRadius: '15px', p: 3,
   gap: 1, boxShadow: '#f4f4f4a1 0px 0px 7px 1px', cursor: 'pointer' }}>
    <Img  onClick={() => navigate(routes.SingleProductPage.createLink(id))} src={images[0]} alt="" sx={{ aspectRatio: '1.2', width: 1, borderRadius: '15px', objectFit: 'contain', background: '#f9f8f8' }} />
